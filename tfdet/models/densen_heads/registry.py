...
def register_densen_head(fn):
    ...
    _densen_head_class[model_name] = cls
    _densen_head_config[model_name] = deepcopy(cfg)
...
def list_densen_heads(
    ...
    if module:
        ...
        all_models = _densen_head_class.keys()
...
def is_densen_heads(model_name):
    """Check if a model name exists"""
    return model_name in _densen_head_class


def densen_head_class(model_name):
    """Fetch a model entrypoint for specified model name"""
    return _densen_head_class[model_name]


def densen_head_config(model_name):
    """Fetch a model config for specified model name"""
    return _densen_head_config[model_name]
...
def is_densen_heads_in_modules(model_name, module_names):
...
def is_densen_head_pretrained(model_name):
